    ...
    if (quranViewModel.currentPageObject?.page?.pageNum?.toInt() !in 1..604) {
        ...
        Column() {
            ...
            TafseerBottomSheet(
                ...
                verseText = quranViewModel.tafseerTargetVerse?.verseText?:"",
                tafseer = quranViewModel.verseTafseer,
                e3rab =  quranViewModel.verseE3rab,
                causeOfRevelation =  quranViewModel.verseCauseOfRevelation,
...
fun PagesContainer(
    ...
    // check whether page swipe is done by viewmodel or user swipe and react accordingly
    // this code might not look optimal but is thus far the best solution we could come up with
