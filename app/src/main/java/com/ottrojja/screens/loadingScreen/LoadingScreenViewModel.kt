...
/* val floatingAzkarEnabled=DataStoreRepository.floatingAzkarFlow.first();
 val isFloatingAzkarServiceRunning= Helpers.isServiceRunning(OverlayService::class.java, context);
 val isGrantedOverlayPermssion= Settings.canDrawOverlays(context)*/
